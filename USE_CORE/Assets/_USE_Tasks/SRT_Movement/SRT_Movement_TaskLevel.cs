...
public class SRT_Movement_TaskLevel : ControlLevel_Task_Template
{
    ...
    public override void DefineControlLevel()
    {
        ...
        SetupBlock.AddDefaultInitializationMethod(() =>
        {
            ...
            {
                string audioFilePath = Session.ResourcesFolderPath + Path.DirectorySeparatorChar + "SRT_Movement/Stimuli/Audio" + Path.DirectorySeparatorChar + ExternalStims.stimDefs[iStim].FileName;
